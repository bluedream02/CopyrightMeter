...
def savemodelDiffusers(name, compvis_config_file, diffusers_config_file, device='cpu'):
    checkpoint_path = f'/data/xunaen/Text-to-image-Copyright/lmx_data_backup/models/{name}/{name}.pt'
    ...
    extract_ema = False
    dump_path = f"/data/xunaen/Text-to-image-Copyright/lmx_data_backup/models/{name}/{name.replace('compvis','diffusers')}.pt"
