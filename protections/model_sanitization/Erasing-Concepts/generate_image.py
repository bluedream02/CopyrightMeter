...
def generate_images(model_name, prompts_path, save_path, device='cuda:0', guidance_scale = 7.5, image_size=512, ddim_steps=100, num_samples=10, from_case=0):
    ...
    if model_name == 'SD-v1-4':
        ...
        dir_ = "/data/xunaen/Text-to-image-Copyright/stable-diffusion-1-5" # all the erasure models built on SDv1-4
    ...
    if 'SD' not in model_name:
        try:
            model_path = f'/data/xunaen/Text-to-image-Copyright/lmx_data_backup/models/{model_name}/{model_name.replace("compvis","diffusers")}.pt'
...
if __name__=='__main__':
    ...
    parser.add_argument('--model_name', help='name of model', type=str, required=False,default="compvis-word_decoritems_houseplant-method_full-sg_3-ng_1-iter_1000-lr_1e-05")
    parser.add_argument('--prompts_path', help='path to csv file with prompts', type=str, required=False,default="/data/xunaen/lmx/lmx_erase/data/decoritems_houseplant.csv")
    parser.add_argument('--save_path', help='folder where to save images', type=str, required=False,default="/data/xunaen/lmx/lmx_erase/result/decoritems_houseplant")
