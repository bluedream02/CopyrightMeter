...
#     PATH = f'{FOLDER}/{model_type}-word_{word_print}-method_{train_method}-sg_{start_guidance}-ng_{neg_guidance}-iter_{i+1}-lr_{lr}-startmodel_{start_model}-numacc_{numacc}.pt'
    ...
    folder_path = f'/data/xunaen/Text-to-image-Copyright/lmx_data_backup/models/{name}'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config_path', help='config path for stable diffusion v1-4 inference', type=str, required=False, default='/data/xunaen/Text-to-image-Copyright/lmx_data_backup/v1.5/v1-inference.yaml')
    parser.add_argument('--ckpt_path', help='ckpt path for stable diffusion v1-4', type=str, required=False, default='/data/xunaen/Text-to-image-Copyright/lmx_data_backup/v1.5/v1-5-pruned.ckpt')
    parser.add_argument('--diffusers_config_path', help='diffusers unet config json path', type=str, required=False, default='/data/xunaen/Text-to-image-Copyright/stable-diffusion-1-5/unet/config.json')
