...
class FrozenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self, version="/data/xunaen/Text-to-image-Copyright/lmx_data_backup/models--openai--clip-vit-large-patch14", device="cuda", max_length=77):  # clip-vit-base-patch32
        super().__init__()
...
class ClipImageProjector(AbstractEncoder):
    """
        ...
        """
    def __init__(self, version="/data/xunaen/Text-to-image-Copyright/lmx_data_backup/models--openai--clip-vit-large-patch14", max_length=77):  # clip-vit-base-patch32
        super().__init__()
