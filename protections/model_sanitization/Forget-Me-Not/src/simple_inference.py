...
def main(args):
    ...
    if args.patch_ti is not None:
        ...
        model_id = "/data/xunaen/Text-to-image-Copyright/stable-diffusion-1-5"
        # /data/xunaen/llms/stable-diffusion-2-1
        ...
        if args.patch_ti.use_template == "object":
            ...
            prompts += [f"a painting by {inverted_tokens}"]
        else:
