...
def main(params):
    ...
    if params.eval_bits:
        ...
        if 'torchscript' in params.msg_decoder_path:
            ...
            print(f'>>> Whitening...')
            with torch.no_grad():
                data_dir = "/data/xunaen/lwj/stable_signature/output_img"
                transform = transforms.Compose([
        ...
        # print(log_stats)
        # print(f"bit_acc_none: ", log_stats['bit_acc_none'].mean())
...
def get_parser():
    ...
    aa("--msg_decoder_path", type=str, default= "/data/xunaen/lwj/stable_signature/dec_48b_whit.torchscript.pt")
