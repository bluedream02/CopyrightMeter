...
if __name__ == "__main__":
    ...
    parser.add_argument('--checkpoint_path', type=str, default='./classifier.pt', help='Path to the trained model checkpoint.')
    parser.add_argument('--data_root', type=str, default='/data/xunaen/lmx/DS_attack_generate/CustomConcept/17_bm3d',help='Root directory of the watermarked images.')
