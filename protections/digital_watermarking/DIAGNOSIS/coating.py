...
dataset_name = "/path/CustomConcept_finetuning"
...
path = './traindata_p'+str(p)+"_"+str(args.target_type)+"_CustomConcept"
...
for i in range(num_sample):
    ...
    if rand_value<p:
        if args.target_type=="watermark":
            ...
            watermark_image = transforms.Compose([transforms.PILToTensor(),transforms.Resize((512,512))])(watermark_image)
